...
const Rounds = (() => {
  ...
  const ROUNDS = [
    /* 1  */ [w(0, 12, "blue", 0.8)],
    /* 2  — first RED sonics: they take two hits (pop once -> blue) */
              [w(0, 12, "blue", 0.6), w(7, 6, "red", 0.75)],
    /* 3  */ [w(0, 10, "blue", 0.65), w(7, 8, "red", 0.7)],
    /* 4  */ [w(0, 18, "blue", 0.5), w(5, 10, "red", 0.6)],
    /* 5  */ [w(0, 16, "red", 0.55), w(9, 6, "green", 0.7)],
    /* 6  */ [w(0, 25, "blue", 0.3), w(4, 12, "red", 0.5)],
    /* 7  */ [w(0, 18, "red", 0.45), w(6, 12, "green", 0.55)],
    /* 8  */ [w(0, 24, "green", 0.45)],
    /* 9  */ [w(0, 30, "red", 0.3), w(5, 12, "green", 0.45)],
    /* 10 */ [w(0, 18, "green", 0.4), w(8, 8, "yellow", 0.7)],
    /* 11 */ [w(0, 30, "green", 0.35)],
    /* 12 */ [w(0, 8, "metal", 1.0), w(3, 16, "green", 0.4)],
    /* 13 */ [w(0, 40, "red", 0.22), w(4, 18, "green", 0.3)],
    /* 14 */ [w(0, 24, "green", 0.3), w(6, 12, "yellow", 0.5)],
    /* 15 */ [w(0, 16, "yellow", 0.45), w(8, 4, "pink", 0.9)],
    /* 16 */ [w(0, 30, "green", 0.25), w(5, 15, "yellow", 0.4)],
    /* 17 */ [w(0, 8, "metal", 0.9), w(4, 4, "shadow", 1.1), w(9, 12, "yellow", 0.45)],
    /* 18 */ [w(0, 24, "yellow", 0.32), w(7, 8, "pink", 0.55)],
    /* 19 */ [w(0, 40, "green", 0.2), w(4, 20, "yellow", 0.3)],
